...
public class BeetlGenCode {
    ...
    private static String url = "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useSSL=false&zeroDateTimeBehavior=convertToNull&serverTimezone=UTC";
    ...
    // ========生成实体类所在的包=========
    private static String pojoPkg = "com.lianxun.beetlsqlservice.entity";
    // ========生成mapper类所在的包=========
    private static String mapperPkg = "com.lianxun.beetlsqlservice.mapper";
